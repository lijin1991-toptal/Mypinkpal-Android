...
import com.brodev.socialapp.view.chats.emoji.EmojiGridFragment;
...
import com.brodev.socialapp.view.base.BaseFragmentActivity;
import com.brodev.socialapp.view.chats.emoji.EmojiFragment;
import com.brodev.socialapp.view.chats.emoji.EmojiGridFragment;
import com.brodev.socialapp.view.chats.emoji.emojiTypes.EmojiObject;
...
import com.brodev.socialapp.utils.KeyboardUtils;
...
public abstract class BaseDialogActivity extends BaseFragmentActivity implements SwitchViewListener, ScrollMessagesListener, EmojiGridFragment.OnEmojiconClickedListener, EmojiFragment.OnEmojiBackspaceClickedListener {
    ...
    private JoinGroupChatSuccessAction joinGroupChatSuccessAction;
    private LoginAndJoinChatSuccessAction loginAndJoinChatSuccessAction;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        joinGroupChatSuccessAction = new JoinGroupChatSuccessAction();
        loginAndJoinChatSuccessAction = new LoginAndJoinChatSuccessAction();
    ...
    protected void addActions() {
        ...
        addAction(QBServiceConsts.JOIN_GROUP_CHAT_SUCCESS_ACTION, joinGroupChatSuccessAction);
        addAction(QBServiceConsts.JOIN_GROUP_CHAT_FAIL_ACTION, failAction);
        addAction(QBServiceConsts.LOGIN_AND_JOIN_CHATS_SUCCESS_ACTION, loginAndJoinChatSuccessAction);
    ...
    public class JoinGroupChatSuccessAction implements Command {
        @Override
        public void execute(Bundle bundle) {
    ...
    public class LoginAndJoinChatSuccessAction implements Command {
        @Override
        public void execute(Bundle bundle) {
