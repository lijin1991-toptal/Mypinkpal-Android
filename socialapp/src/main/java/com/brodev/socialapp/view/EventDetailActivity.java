...
import com.brodev.socialapp.fragment.EventDetailFragment;
import com.brodev.socialapp.fragment.EventMemberFragment;
...
public class EventDetailActivity extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTabsAdapter.addTab(mTabHost.newTabSpec("wall").setIndicator(phraseManager.getPhrase(getApplicationContext(), "accountapi.info")),
				EventDetailFragment.class, extras);
		
		mTabsAdapter.addTab(mTabHost.newTabSpec("info").setIndicator(phraseManager.getPhrase(getApplicationContext(), "accountapi.member")),
