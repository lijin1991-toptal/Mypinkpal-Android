...
import com.brodev.socialapp.view.media.MediaPlayerManager;
import com.brodev.socialapp.view.videocall.VideoCallFragment;
import com.brodev.socialapp.view.voicecall.VoiceCallFragment;
...
public class CallActivity extends BaseLogeableActivity implements IncomingCallFragment.IncomingCallClickListener, OutgoingCallFragment.OutgoingCallListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.hide();
        mediaPlayer = com.brodev.socialapp.entity.User.getInstance().getMediaPlayer();
