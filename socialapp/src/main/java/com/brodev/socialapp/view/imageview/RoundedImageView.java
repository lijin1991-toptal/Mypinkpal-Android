package com.brodev.socialapp.view.imageview;
...
import com.brodev.socialapp.fragment.invites.RoundedDrawable;
...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        borderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_qbborder_width, -1);
        ...
        borderColor = a.getColorStateList(R.styleable.RoundedImageView_qbborder_color);
        if (borderColor == null) {
