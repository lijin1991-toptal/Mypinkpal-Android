package com.brodev.chat.adapter;
...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        QBUser currentUser = ((User)context.getApplication()).getCurrentUser();
    ...
    private ViewHolder createViewHolder(View v) {
        ...
        holder.content = (LinearLayout) v.findViewById(R.id.list_item_message_content);
