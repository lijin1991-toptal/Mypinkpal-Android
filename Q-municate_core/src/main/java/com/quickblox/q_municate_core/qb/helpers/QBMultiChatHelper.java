...
public class QBMultiChatHelper extends BaseChatHelper {
    ...
    public QBDialog createGroupChat(String name,
                                    List<Integer> friendIdsList, QBDialogType type) throws Exception {
    ...
    public void sendOccupantStatusGroup(String sendStr) {
        ...
        chatMessage.setProperty(ChatUtils.PROPERTY_NOTIFICATION_TYPE, ChatUtils.PROPERTY_NOTIFICATION_TYPE_CREATE_CHAT);
        ...
        chatMessage.setProperty(ChatUtils.PROPERTY_OCCUPANTS_IDS, TextUtils.join(ChatUtils.OCCUPANT_IDS_DIVIDER, currentDialog.getOccupants()));
        chatMessage.setProperty(ChatUtils.PROPERTY_ROOM_NAME, currentDialog.getName());
        chatMessage.setProperty(ChatUtils.PROPERTY_DIALOG_TYPE_CODE, String.valueOf(currentDialog.getType().getCode()));
        chatMessage.setProperty(ChatUtils.PROPERTY_DATE_SENT, time + ConstsCore.EMPTY_STRING);
