...
//    public static final String QB_AUTH_SECRET = "xS2uerEveGHmEun";
    public static final String QB_APP_ID = "7052";
    public static final String QB_AUTH_KEY = "TFpRCByLuSQ8mCN";
    public static final String QB_AUTH_SECRET = "XMpzyKX6wKJKba7";
